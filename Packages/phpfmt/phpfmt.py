...
def dofmt(eself, eview, sgter = None, src = None, force = False):
    ...
    cmd_ver = [php_bin, '-v'];
    p = subprocess.Popen(cmd_ver, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=False, startupinfo=globalStartupInfo)
    ...
    if "AutoSemicolon" in passes:
        ...
        if src is None:
            cmd_lint.append(uri)
            p = subprocess.Popen(cmd_lint, stdout=subprocess.PIPE, stderr=subprocess.PIPE, cwd=dirnm, shell=False, startupinfo=globalStartupInfo)
        else:
            p = subprocess.Popen(cmd_lint, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=False, startupinfo=globalStartupInfo)
    ...
    if(lintret==0):
        ...
        if src is None:
            p = subprocess.Popen(cmd_fmt, stdout=subprocess.PIPE, stderr=subprocess.PIPE, cwd=dirnm, shell=False, startupinfo=globalStartupInfo)
        else:
            p = subprocess.Popen(cmd_fmt, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=False, startupinfo=globalStartupInfo)
...
class TogglePassMenuCommand(sublime_plugin.TextCommand):
    def run(self, edit):
        ...
        p = subprocess.Popen(cmd_passes, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=False, startupinfo=globalStartupInfo)
